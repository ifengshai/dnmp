...
order by sfoi.item_id asc limit 1000";
    ...
    {
        $order_entity_id_querySql = "select sfo.entity_id from sales_flat_order sfo where sfo.custom_order_prescription_type = 2 order by entity_id desc limit 40000 ";
