...
class Test extends Backend
{
    ...
    public function demo()
    {
        $str = [
            "address_id"=> "0",
            "shipping_type"=>"flatrate_flatrate",
            "currency_code"=> "USD",
            "firstname"=>"Aurora",
            "lastname"=>"Cecilia Morales López",
            "email"=> "cecilia.morales22@hotmail.com",
            "telephone"=> "+52 5527296728",
            "country_id"=> "MX",
            "region_id"=> "0",
            "city"=> "México",
            "street"=> "San Miguel Regla 73Club de Golf Hacienda",
            "postcode"=> "52959"
          ];
