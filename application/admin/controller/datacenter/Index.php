...
class Index extends Backend
{
    ...
    protected function order_sku_num($create_time)
    {
        ...
        from sales_flat_order_item_prescription as p join sales_flat_order as o on p.order_id=o.entity_id where o.status in ('free_processing', 'processing', 'paypal_reversed', 'paypal_canceled_reversal', 'complete','delivered','delivery') and  $where ) b where sph != '' and cyl != '' limit 1";
