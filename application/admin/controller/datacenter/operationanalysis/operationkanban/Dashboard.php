...
class Dashboard extends Backend
{
    ...
    public function index()
    {
        ...
        foreach ($list as $v) {
            $zeeloolSalesNumList[$v['create_date']]  			 = $v['zeelool_sales_num'] ?: 0;
            $vooguemeSalesNumList[$v['create_date']] 			 = $v['voogueme_sales_num'] ?:0;
			$nihaoSalesNumList[$v['create_date']]    			 = $v['nihao_sales_num'] ?:0;
			$meeloogSalesNumList[$v['create_date']]    			 = $v['meeloog_sales_num'] ?:0;
            $zeeloolSalesMoneyList[$v['create_date']] 			 = $v['zeelool_sales_money'] ?:0;
            $vooguemeSalesMoneyList[$v['create_date']]			 = $v['voogueme_sales_money'] ?:0;
			$nihaoSalesMoneyList[$v['create_date']]				 = $v['nihao_sales_money'] ?:0;
			$meeloogSalesMoneyList[$v['create_date']]			 = $v['meeloog_sales_money'] ?:0;
            $zeeloolUnitPriceList[$v['create_date']]			 = $v['zeelool_unit_price'] ?:0;
            $vooguemeUnitPriceList[$v['create_date']]			 = $v['voogueme_unit_price'] ?:0;
			$nihaoUnitPriceList[$v['create_date']]				 = $v['nihao_unit_price'] ?:0;
			$meeloogUnitPriceList[$v['create_date']]			 = $v['meeloog_unit_price'] ?:0;
            $zeeloolShoppingcartTotal[$v['create_date']]		 = $v['zeelool_shoppingcart_total'] ?:0;
            $vooguemeShoppingcartTotal[$v['create_date']]		 = $v['voogueme_shoppingcart_total'] ?:0;
			$nihaoShoppingcartTotal[$v['create_date']]			 = $v['nihao_shoppingcart_total'] ?:0;
			$meeloogShoppingcartTotal[$v['create_date']]		 = $v['meeloog_shoppingcart_total'] ?:0;
            $zeeloolShoppingcartConversion[$v['create_date']]	 = $v['zeelool_shoppingcart_conversion'] ?:0;
            $vooguemeShoppingcartConversion[$v['create_date']]   = $v['voogueme_shoppingcart_conversion'] ?:0;
            $nihaoShoppingcartConversion[$v['create_date']]	     = $v['nihao_shoppingcart_conversion'] ?:0;
			$meeloogShoppingcartConversion[$v['create_date']]	 = $v['meeloog_shoppingcart_conversion'] ?:0;
			$zeeloolRegisterCustomer[$v['create_date']]		     = $v['zeelool_register_customer'] ?:0;
            $vooguemeRegisterCustomer[$v['create_date']]		 = $v['voogueme_register_customer'] ?:0;
			$nihaoRegisterCustomer[$v['create_date']]			 = $v['nihao_register_customer'] ?:0;
			$meeloogRegisterCustomer[$v['create_date']]			 = $v['meeloog_register_customer'] ?:0;
        }
        //下边部分数据 默认30天数据
    ...
    public function get_platform_data($map)
    {
        ...
        $arr = [
            ...
            'nihao_pc_unit_price' 		=> $nihao_pc_unit_price,
			'nihao_wap_unit_price' 		=> $nihao_wap_unit_price,
            'meeloog_pc_sales_money' 	=> $meeloog_pc_sales_money,
            'meeloog_wap_sales_money' 	=> $meeloog_wap_sales_money,
            'meeloog_pc_sales_num' 		=> $meeloog_pc_sales_num,
            'meeloog_wap_sales_num' 	=> $meeloog_wap_sales_num,
            'meeloog_pc_unit_price' 	=> $meeloog_pc_unit_price,
            'meeloog_wap_unit_price' 	=> $meeloog_wap_unit_price,			
        ];
