...
class TrackReg extends Backend
{
    ...
    public function zeelool_day_data()
    {
        ...
        $arr['presell_num'] =$item_platform->where($map_where)->where('presell_status',1)->count();
    ...
    public function other_day_data(){
        ...
        $date_time = date('Y-m-d', strtotime("-1 day"));
        //meeloog
        $map_where['platform_type'] = $platform_where['platform_type'] = 4;
        ...
        //批发站
        $map_where['platform_type'] = $platform_where['platform_type'] = 5;
        $arr['site'] = 5;
        $arr['virtual_stock'] = $model->where($where)->where($platform_where)->sum('stock');
        //在售，预售，下架
        $arr['in_sale_num'] =$item_platform->where($map_where)->where('outer_sku_status',1)->count();
        ...
        //亚马逊
        $map_where['platform_type'] = $platform_where['platform_type'] = 8;
        $arr['site'] = 8;
        $arr['virtual_stock'] = $model->where($where)->where($platform_where)->sum('stock');
        //在售，预售，下架
        $arr['in_sale_num'] =$item_platform->where($map_where)->where('outer_sku_status',1)->count();
        ...
        //zeelool_es
        $map_where['platform_type'] = $platform_where['platform_type'] = 9;
        $arr['site'] = 9;
        $arr['virtual_stock'] = $model->where($where)->where($platform_where)->sum('stock');
        //在售，预售，下架
        $arr['in_sale_num'] =$item_platform->where($map_where)->where('outer_sku_status',1)->count();
        ...
        //zeelool_de
        $map_where['platform_type'] = $platform_where['platform_type'] = 10;
        $arr['site'] = 10;
        $arr['virtual_stock'] = $model->where($where)->where($platform_where)->sum('stock');
        //在售，预售，下架
        $arr['in_sale_num'] =$item_platform->where($map_where)->where('outer_sku_status',1)->count();
        ...
        //zeelool_jp
        $map_where['platform_type'] = $platform_where['platform_type'] = 11;
        $arr['site'] = 11;
        $arr['virtual_stock'] = $model->where($where)->where($platform_where)->sum('stock');
        //在售，预售，下架
        $arr['in_sale_num'] =$item_platform->where($map_where)->where('outer_sku_status',1)->count();
