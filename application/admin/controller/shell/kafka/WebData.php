...
class WebData extends Backend
{
    ...
    {
        $webUsers = new WebUsers();
        $entity_id = $webUsers->where(['site' => 5])->order('entity_id desc')->value('entity_id');
