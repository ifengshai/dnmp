...
class Zeelool extends Model
{
    ...
    public function getCountryNum($time_str = ''){
        ...
        //获取所有的订单的国家
        $country_arr = $this->model->alias('o')->join('sales_flat_order_address oa','o.entity_id=oa.parent_id')->where($order_where)->group('oa.country_id')->field('oa.country_id,count(oa.country_id) count')->order('count desc')->select(false);
        echo $country_arr;exit;
        //总订单数
