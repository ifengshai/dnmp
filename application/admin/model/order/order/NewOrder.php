...
class NewOrder extends Model
{
    ...
    public function getSkuSalesNumShell($sku, $site, $createTime)
    {
        ...
        $map['a.status'] = ['in', [ 'processing', 'complete', 'delivered','delivery']];
    ...
    public function getOrderSalesNum($sku = [], $where)
    {
        ...
        $map['a.status'] = ['in', ['free_processing', 'processing', 'complete', 'paypal_reversed', 'payment_review', 'paypal_canceled_reversal','delivered','delivery','shipped']];
        $list = $this
            ->alias('a')
