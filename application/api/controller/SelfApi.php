...
class SelfApi extends Api
{
    ...
    public function order_delivery()
    {
        ...
        $test = Db::connect('database.db_delivery')->table('ld_deliver_order')->where(['track_number' => '9400111108296818283602', 'increment_id' => '100171868'])->value('agent_way_title');
        //更新节点主表
        ...
        file_put_contents('/www/wwwroot/mojing/runtime/log/order_delivery.log', $track_number . '-' . $shipment_data_type . '-' . $test . "\r\n", FILE_APPEND);
        //注册17track
