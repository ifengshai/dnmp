...
return [
    ...
    'db_delivery' => [
        // 数据库类型
        'type'        => Env::get('db_delivery.type'),
        // 服务器地址
        'hostname'    => Env::get('db_delivery.hostname'),
        // 数据库名
        'database'    => Env::get('db_delivery.database'),
        // 数据库用户名
        'username'    => Env::get('db_delivery.username'),
        // 密码
        'password'    => Env::get('db_delivery.password'),
        // 数据库编码默认采用utf8
        'charset'     => Env::get('db_delivery.charset'),
        'prefix'      => Env::get('db_delivery.prefix'),
    ],

    'db_wesee_temp' => [
        // 数据库类型
        'type'        => Env::get('db_wesee_temp.type'),
        // 服务器地址
        'hostname'    => Env::get('db_wesee_temp.hostname'),
        // 数据库名
        'database'    => Env::get('db_wesee_temp.database'),
        // 数据库用户名
        'username'    => Env::get('db_wesee_temp.username'),
        // 密码
        'password'    => Env::get('db_wesee_temp.password'),
        // 数据库编码默认采用utf8
    ...
    'db_zeelool_fr_online' => [
        // 数据库类型
        'type'     => Env::get('db_zeelool_fr_online.type'),
        // 服务器地址
        'hostname' => Env::get('db_zeelool_fr_online.hostname'),
        // 数据库名
        'database' => Env::get('db_zeelool_fr_online.database'),
        // 数据库用户名
        'username' => Env::get('db_zeelool_fr_online.username'),
        // 密码
        'password' => Env::get('db_zeelool_fr_online.password'),
        // 数据库编码默认采用utf8
