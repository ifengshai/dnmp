...
class EsFormatData
{
    ...
    public function formatDashBoardData($site, $data, $compareData = [], $siteAll = false)
    {
        ...
        //销售额
        $salesTotalMoney = round($data['salesTotalMoney']['value'], 2);
        //邮费
        ...
        if ($compareData) {
            ...
            //销售额
            $compareSalesTotalMoney = round($compareData['salesTotalMoney']['value'], 2);
            //邮费
            $compareShippingTotalMoney = round($compareData['shippingTotalMoney']['value'], 2);
            //客单价
        ...
        foreach ($siteBuckets as $key => $val) {
            ...
            foreach ($storeBuckets as $k => $v) {
                ...
                $str .= '<tr>
                            ...
                            <td style="text-align: center; vertical-align: middle;">' . round($v['allDaySalesAmount']['value'], 2) . '</td>
                            <td style="text-align: center; vertical-align: middle;">' . $v['doc_count'] . '</td>
                            <td style="text-align: center; vertical-align: middle;">' . round($v['allAvgPrice']['value'], 2) . '</td>
                        </tr>';
                $i++;
            }
        }
