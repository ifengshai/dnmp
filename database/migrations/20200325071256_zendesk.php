...
class Zendesk extends Migrator
{
    ...
    {
        $table = $this->table('zendesk', array('engine' => 'InnoDB', 'signed' => false,'collation' => 'utf8mb4_general_ci'));
        $table->addColumn('ticket_id','integer',array('limit' => 7, 'signed' => false, 'comment' => '邮件id'))
            ...
            ->addColumn('tags', 'string', array('limit' => 100,'null' => true, 'comment' => 'tags,多个用，号连接，使用的tag的id连接'))
            ->addColumn('subject', 'string', array('limit' => 1000,'null' => true, 'comment' => '邮件主题'))
            ->addColumn('raw_subject', 'string', array('limit' => 1000,'null' => true, 'comment' => '邮件副主题'))
            ...
            ->addColumn('comment','string', array('limit' => 1000,'null' => true, 'comment' => '评分的内容'))
            ->addColumn('reason','string', array('limit' => 1000,'null' => true, 'comment' => '评分的原因'))
