...
class ZendeskComments extends Migrator
{
    ...
    {
        $table = $this->table('zendesk_comments', array('engine' => 'InnoDB', 'signed' => false));
        $table->addColumn('ticket_id','integer',array('limit' => 7, 'signed' => false, 'comment' => '邮件id'))
            ->addColumn('zid', 'integer', array('limit' => MysqlAdapter::INT_TINY,'default' => 0,'signed'=>false, 'comment' => 'zendesk对应主表id'))
            ->addColumn('author_id', 'string', array('limit' => 20, 'comment' => '回复人id，对应的zendesk'))
            ->addColumn('due_id', 'integer', array('limit' => MysqlAdapter::INT_TINY,'default' => 0,'signed'=>false, 'comment' => '处理人id，对应系统的用户id'))
            ->addColumn('body', 'text', array( 'null' => true,'comment' => '回复内容'))
            ->addColumn('html_body', 'text', array('null' => true,'comment' => '回复内容html格式'))
