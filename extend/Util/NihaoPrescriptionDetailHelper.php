	...
	*/
	protected function list_convert($item_list){
		...
		foreach ($item_list as $item_key => $item_value) {
            ...
            $items[$item_key]['index_name']  = $product_options['info_buyRequest']['tmplens']['third_name'] . ' ' . $product_options['info_buyRequest']['tmplens']['lens_type'] . ' ' . $product_options['info_buyRequest']['tmplens']['color_name'];
