define(['jquery', 'bootstrap', 'backend', 'table', 'form','nkeditor', 'upload'], function ($, undefined, Backend, Table, Form,Nkeditor, Upload) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'demand/rdc_it_web_demand/index' + location.search,
                    add_url: 'demand/rdc_it_web_demand/add',
                    edit_url: 'demand/rdc_it_web_demand/edit/demand_type/2',
                    del_url: 'demand/rdc_it_web_demand/del',
                    multi_url: 'demand/rdc_it_web_demand/multi',
                    table: 'rdc_it_web_demand',
                }
            });
            ...
            $(document).on('click', ".web_distribution", function () {
                ...
                Fast.api.open('demand/rdc_it_web_demand/distribution?id=' + id, '分配', options);
            });
        },
        index1: function () {
            // 初始化表格参数配置
