        ...
        api: {
            formatter: {
                ...
                user_chart: function () {
                    ...
                    var options = {
                        type: 'post',
                        url: 'elasticsearch/operate/user_data/ajax_top_data',
                        data: {
                            order_platform: $("#order_platform").val(),
                            time_str: $("#time_str").val(),
                            time_str2 :  $("#time_str2").val(),
                            type: 1
                        }
                    }
