                ...
                table1.bootstrapTable({
                    ...
                    columns: [
                        [
                            ...
                            {field: 'site', title: '平台'},
                            {field: 'order_type', title: __('订单类型'),custom: { 1: 'danger', 2: 'success'}, searchList: { 1: '普通订单', 2: '网红单'},formatter: Table.api.formatter.status},
                            ...
                            {field: 'is_carry_forward', title: __('是否结转'),custom: { 1: 'danger', 2: 'success'}, searchList: { 1: '已结转', 2: '未结转'},formatter: Table.api.formatter.status},
