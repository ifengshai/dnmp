                ...
                columns: [
                    [
                        ...
                        },
                        {
                            field: 'site',
                            title: __('站点类型'),
                            searchList: { 0: '全部', 1: 'zeelool', 2: 'Voogueme', 3: 'Nihao', 4: 'Meeloog', 5: 'Wesee', 8: 'Amazon', 9: 'Zeelool_es', 10: 'Zeelool_de', 11: 'Zeelool_jp', 12: 'Voogmechic', 13: 'Zeelool_cn', 14: 'Alibaba', 15: 'Zeelool_fr' },
                        ...
                        },
                        {
                            field: 'modular',
                            title: __('模块'),
                            searchList: { 1: '普通订单', 2: '配货', 3: '质检', 4: '审单', 5: '异常处理', 6: '更改镜架', 7: '取消订单', 8: '补发', 9: '赠品', 10: '采购入库', 11: '出入库', 12: '盘点', 13: '调拨', 14: '实体仓调拨' },
                            formatter: Table.api.formatter.status
                        },
                        {
                            field: 'change_type',
                            title: __('变动类型'),
                            searchList: {
                                1: '非预售下单', 2: '预售下单-虚拟仓>0', 3: '预售下单-虚拟仓<0', 4: '配货', 5: '质检拒绝-镜架报损', 6: '审单-成功', 7: '审单-配错镜框'
                                , 8: '加工异常打回待配货', 9: '印logo异常打回待配货', 10: '更改镜架-配镜架前', 11: '更改镜架-配镜架后', 12: '取消订单-配镜架前', 13: '取消订单-配镜架后'
                                , 14: '补发', 15: '赠品', 16: '采购-有比例入库', 17: '采购-没有比例入库', 18: '手动入库', 19: '手动出库', 20: '盘盈入库', 21: '盘亏出库', 22: '库存调拨', 23: '采购单审核通过', 24: '采购单签收完成', 25: '实体仓调拨出库', 26: '实体仓调拨入库'
                            },
                            formatter: Table.api.formatter.status
                        },
                        { field: 'sku', title: __('sku'), operate: 'like' },
                        {
                            field: 'number_type',
                            title: __('关联单号类型'),
                            searchList: { 1: '订单号', 2: '子订单号', 3: '入库单', 4: '出库单', 5: '盘点单', 6: '调拨单', 7: '采购单', 8: '实体仓调拨单' },
                            custom: { 1: 'yellow', 2: 'blue', 3: 'success', 4: 'red', 5: 'danger', 6: 'green' },
                            formatter: Table.api.formatter.status
                        },
                        { field: 'order_number', title: __('关联单号'), operate: 'like' },
