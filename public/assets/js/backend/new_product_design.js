            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'zeelool', title: __('zeelool虚拟仓库存'),operate: false,visible: false},
                        {field: 'voogueme', title: __('voogueme虚拟仓库存'),operate: false,visible: false},
                        {field: 'meeloog', title: __('meeloog虚拟仓库存'),operate: false,visible: false},
                        {field: 'vicmoo', title: __('vicmoo虚拟仓库存'),operate: false,visible: false},
                        {field: 'wesee', title: __('wesee虚拟仓库存'),operate: false,visible: false},
                        {field: 'amazon', title: __('amazon虚拟仓库存'),operate: false,visible: false},
                        {field: 'zeelool_es', title: __('zeelool_es虚拟仓库存'),operate: false,visible: false},
                        {field: 'zeelool_de', title: __('zeelool_de虚拟仓库存'),operate: false,visible: false},
                        {field: 'zeelool_jp', title: __('zeelool_jp虚拟仓库存'),operate: false,visible: false},
                        {field: 'voogmechic', title: __('voogmechic虚拟仓库存'),operate: false,visible: false},
                        {field: 'zeelool_cn', title: __('zeelool_cn虚拟仓库存'),operate: false,visible: false},
                        {field: 'alibaba', title: __('alibaba虚拟仓库存'),operate: false,visible: false},
                        {field: 'zeelool_fr', title: __('zeelool_fr虚拟仓库存'),operate: false,visible: false},
