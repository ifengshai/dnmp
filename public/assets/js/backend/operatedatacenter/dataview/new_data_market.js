...
function stock_data(){
    ...
    Backend.api.ajax({
        url: 'operatedatacenter/dataview/new_data_market/stock_data',
        data: {order_platform: order_platform}
    }, function (data, ret) {
        $("#stock").html(ret.data.stock);
        $("#dull_stock").html(ret.data.dull_stock);
        $("#stock_total").html(ret.data.stock_total);
        $("#dull_stock_total").html(ret.data.dull_stock_total);
        $("#turn_month").html(ret.data.turn_month);
        $("#shelves_sales_num_thirty").html(ret.data.shelves_sales_num_thirty);
        $("#sales_num_thirty").html(ret.data.sales_num_thirty);
        $("#sales_num_rate").html(ret.data.sales_num_rate+'%');
        return false;
    }, function (data, ret) {
        Layer.alert(ret.msg);
        return false;
