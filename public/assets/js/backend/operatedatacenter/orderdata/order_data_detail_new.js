define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'operatedatacenter/orderdata/order_data_detail_new/index' + location.search,
                    add_url: 'operatedatacenter/orderdata/order_data_detail_new/add',
                    edit_url: 'operatedatacenter/orderdata/order_data_detail_new/edit',
                    del_url: 'operatedatacenter/orderdata/order_data_detail_new/del',
                    multi_url: 'operatedatacenter/orderdata/order_data_detail_new/multi',
                    table: 'order_data_detail_new',
                }
            });
                ...
                columns: [
                    [
                        ...
                        //{field: 'assign_id', title: __('Assgin_id'),operate: false,visible:false},
                        {
                            ...
                            searchList: {1: 'PC', 4: 'M', 5: 'IOS', 6: 'Android'},
                            formatter: Table.api.formatter.store_id,
                            visible: false,
                            operate: false
                        },
                        {
            ...
            $("#export").click(function(){
                ...
                var field = $('#field').val();
                window.location.href=Config.moduleurl+'/operatedatacenter/orderdata/order_data_detail_new/export?order_platform='+order_platform+'&time_str='+time_str+'&increment_id='+increment_id+'&order_status='+order_status+'&customer_type='+customer_type+'&store_id='+store_id+'&field='+field;
            });
        },
        add: function () {
            Controller.api.bindevent();
