            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'order_num', title: __('总支付订单数'),visible: false,operate:false,sortable: true},
                        {field: 'order_amount', title: __('总订单金额'),visible: false,operate:false,sortable: true},
                        {field: 'point',title: __('积分余额'),visible: false,operate:false,sortable: true},
                        {field: 'coupon_order_num',title: __('使用优惠券订单数'),visible: false,operate:false,sortable: true},
                        {field: 'coupon_order_amount',title: __('使用优惠券订单金额'),visible: false,operate:false,sortable: true},
                        ...
                        {field: 'recommend_order_num',title: __('推荐订单数'),visible: false,operate:false,sortable: true},
                        {field: 'recommend_register_num',title: __('推荐注册量'),visible: false,operate:false,sortable: true},
                    ]
                ],
            });
             // 为表格绑定事件
