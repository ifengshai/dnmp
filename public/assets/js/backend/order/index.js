        ...
        index: function () {
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        { checkbox: true },
                        { field: 'entity_id', title: __('记录标识001'), operate: false },
                        ...
                        { field: 'custom_order_prescription_type', title: __('处方类型'), custom: { 1: 'green', 2: 'green', 3: 'green', 4: 'green', 5: 'green', 6: 'green', }, searchList: { 1: '仅镜架', 2: '现货处方镜', 3: '定制处方镜', 4: '镜架+现货', 5: '镜架+定制', 6: '现片+定制片', 0: '获取中', '': '获取中' }, formatter: Table.api.formatter.status },
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        { checkbox: true },
                        { field: 'entity_id', title: __('记录标识002'), operate: false },
                        //默认隐藏该列
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        //sortable为是否排序,operate为搜索时的操作符,visible表示是否可见
                        { checkbox: true },
                        { field: 'entity_id', title: __('记录标识003'), operate: false },
                        //默认隐藏该列
                        { field: 'increment_id', title: __('订单号') },
