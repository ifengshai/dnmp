            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        { field: 'custom_order_prescription_type', title: __('处方类型'), custom: { 1: 'green', 2: 'green', 3: 'green', 4: 'green', 5: 'green', 6: 'green', }, searchList: { 1: '仅镜架', 2: '现货处方镜', 3: '定制处方镜', 4: '镜架+现货', 5: '镜架+定制', 6: '现片+定制片', 0: '获取中' }, formatter: Table.api.formatter.status },
