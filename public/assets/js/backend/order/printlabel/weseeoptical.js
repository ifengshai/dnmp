    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                ...
                extend: {
                    index_url: 'order/printlabel/weseeoptical/index' + location.search,
                    multi_url: 'order/printlabel/weseeoptical/multi',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        { field: 'status', title: __('状态'), addClass: 'selectpicker', data: 'multiple', operate: 'IN', searchList: { "processing": __('processing'), "free_processing": __('free_processing'), "creditcard_proccessing": "creditcard_proccessing", "paypal_reversed": "paypal_reversed", 'complete': 'complete' } },
                        ...
                        { field: 'custom_order_prescription_type', title: __('处方类型'), addClass: 'selectpicker', data: 'multiple', operate: 'IN', custom: { 1: 'green', 2: 'green', 3: 'green', 4: 'green', 5: 'green', 6: 'green', }, searchList: { 1: '仅镜架', 2: '现货处方镜', 3: '定制处方镜', 4: '镜架+现货', 5: '镜架+定制', 6: '现片+定制片', '': '待处理' }, formatter: Table.api.formatter.status },
                        ...
                        { field: 'custom_print_label_created_at_new', title: __('打印标签时间'), operate: 'RANGE', sortable: true, addclass: 'datetimerange', visible: false },
                        { field: 'custom_match_frame_created_at_new', title: __('配镜架时间'), operate: 'RANGE', sortable: true, addclass: 'datetimerange', visible: false },
                        { field: 'custom_match_lens_created_at_new', title: __('配镜片时间'), operate: 'RANGE', sortable: true, addclass: 'datetimerange', visible: false },
                        { field: 'custom_match_factory_created_at_new', title: __('加工时间'), operate: 'RANGE', sortable: true, addclass: 'datetimerange', visible: false },
                            ...
                            field: 'operate', title: __('Operate'), table: table, events: Table.api.events.operate, buttons: [
                                {
                                    ...
                                    icon: 'fa fa-list',
                                    url: 'order/printlabel/weseeoptical/detail?label=' + Config.label,
                                ...
                                },
                                {
                                    ...
                                    classname: 'btn btn-xs  btn-primary  btn-dialog',
                                    icon: 'fa fa-list',
                                    url: 'order/printlabel/weseeoptical/operational',
            ...
            $('.btn-batch-printed').click(function () {
                ...
                window.open(Config.moduleurl + '/order/printlabel/weseeoptical/batch_print_label/id_params/' + id_params, '_blank');
            });
            ...
            $('.btn-batch-export-xls').click(function () {
                var ids = Table.api.selectedids(table);
                if (ids.length > 0) {
                    window.open(Config.moduleurl + '/order/printlabel/weseeoptical/batch_export_xls?id_params=' + ids, '_blank');
                } else {
                    var options = table.bootstrapTable('getOptions');
                    var search = options.queryParams({});
                    var filter = search.filter;
                    var op = search.op;
                    window.open(Config.moduleurl + '/order/printlabel/weseeoptical/batch_export_xls?filter=' + filter + '&op=' + op, '_blank');
                }
            ...
            $('.btn-tag-printed').click(function () {
                ...
                Layer.confirm(
                    ...
                    function (index) {
                        Layer.close(index);
                        Backend.api.ajax({
                            url: Config.moduleurl + '/order/printlabel/weseeoptical/tag_printed',
                            data: { id_params: ids },
                            type: 'post'
                        }, function (data, ret) {
                            if (data == 'success') {
            ...
            $('.btn-set-status').click(function () {
                ...
                Layer.confirm(
                    ...
                    function (index) {
                        Layer.close(index);
                        Backend.api.ajax({
                            url: Config.moduleurl + '/order/printlabel/weseeoptical/setOrderStatus',
        ...
        _list: function () {
            ...
            Table.api.init({
                ...
                showToggle: false,
                extend: {
                    index_url: 'order/printlabel/weseeoptical/_list' + location.search,
                    table: 'sales_flat_order',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        { field: 'status', title: __('状态'), searchList: { "processing": __('processing'), "free_processing": __('free_processing'), "paypal_reversed": "paypal_reversed", "creditcard_proccessing": "creditcard_proccessing" } },
                        { field: 'base_grand_total', title: __('订单金额'), operate: false, formatter: Controller.api.formatter.float_format },
                        { field: 'base_shipping_amount', title: __('运费'), operate: false, formatter: Controller.api.formatter.float_format },
                            ...
                            field: 'operate', title: __('Operate'), table: table, events: Table.api.events.operate, buttons: [
                                {
                                    ...
                                    classname: 'btn btn-xs  btn-primary  btn-dialog',
                                    icon: 'fa fa-list',
                                    url: 'order/printlabel/weseeoptical/detail',
            ...
            $('.btn-batch-export-xls').click(function () {
                ...
                window.open(Config.moduleurl + '/order/printlabel/weseeoptical/batch_export_xls/id_params/' + id_params, '_blank');
            });
            ...
            $(document).on('input', '#search_val', function (events) {
                if (event.target.value.length == 9) {
                    Backend.api.ajax({
                        url: Config.moduleurl + '/order/printlabel/weseeoptical/_list',
        ...
        operational: function () {
            ...
            Table.api.init({
                ...
                pagination: false,
                extend: {
                    index_url: 'order/printlabel/weseeoptical/operational' + location.search + '&ids=' + Config.ids,
                }
            });
