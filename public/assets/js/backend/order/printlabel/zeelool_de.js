    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                ...
                extend: {
                    index_url: 'order/printlabel/zeelool_de/index' + location.search,
                    multi_url: 'order/printlabel/zeelool_de/multi',
                            ...
                            field: 'operate', title: __('Operate'), table: table, events: Table.api.events.operate, buttons: [
                                {
                                    ...
                                    icon: 'fa fa-list',
                                    url: 'order/printlabel/zeelool_de/detail',
                                ...
                                },
                                {
                                    ...
                                    classname: 'btn btn-xs  btn-primary  btn-dialog',
                                    icon: 'fa fa-list',
                                    url: 'order/printlabel/zeelool_de/operational',
            ...
            $('.btn-batch-printed').click(function () {
                ...
                window.open(Config.moduleurl + '/order/printlabel/zeelool_de/batch_print_label/id_params/' + id_params, '_blank');
            });
            ...
            $('.btn-batch-export-xls').click(function () {
                var ids = Table.api.selectedids(table);
                if (ids.length > 0) {
                    window.open(Config.moduleurl + '/order/printlabel/zeelool_de/batch_export_xls?id_params=' + ids, '_blank');
                } else {
                    var options = table.bootstrapTable('getOptions');
                    var search = options.queryParams({});
                    var filter = search.filter;
                    var op = search.op;
                    window.open(Config.moduleurl + '/order/printlabel/zeelool_de/batch_export_xls?filter=' + filter + '&op=' + op, '_blank');
                }
            ...
            $('.btn-tag-printed').click(function () {
                ...
                Layer.confirm(
                    ...
                    function (index) {
                        Layer.close(index);
                        Backend.api.ajax({
                            url: Config.moduleurl + '/order/printlabel/zeelool_de/tag_printed',
                            data: { id_params: ids },
                            type: 'post'
                        }, function (data, ret) {
                            if (data == 'success') {
            ...
            $('.btn-set-status').click(function () {
                ...
                Layer.confirm(
                    ...
                    function (index) {
                        Layer.close(index);
                        Backend.api.ajax({
                            url: Config.moduleurl + '/order/printlabel/zeelool_de/setOrderStatus',
        ...
        operational: function () {
            ...
            Table.api.init({
                ...
                pagination: false,
                extend: {
                    index_url: 'order/printlabel/zeelool_de/operational' + location.search + '&ids=' + Config.ids,
                }
            });
        ...
        _list: function () {
            ...
            Table.api.init({
                ...
                showToggle: false,
                extend: {
                    index_url: 'order/printlabel/zeelool_de/_list' + location.search,
                    table: 'sales_flat_order',
                }
            });
            ...
            $('.btn-batch-export-xls').click(function () {
                ...
                window.open(Config.moduleurl + '/order/printlabel/zeelool_de/batch_export_xls/id_params/' + id_params, '_blank');
            });
            ...
            $(document).on('input', '#search_val', function (events) {
                if (event.target.value.length == 9) {
                    Backend.api.ajax({
                        url: Config.moduleurl + '/order/printlabel/zeelool_de/_list',
