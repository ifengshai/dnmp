    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                ...
                extend: {
                    index_url: 'order/printlabel/zeelool_jp/index' + location.search,
                    multi_url: 'order/printlabel/zeelool_jp/multi',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        { field: 'custom_order_prescription_type', title: __('处方类型'), addClass: 'selectpicker', data: 'multiple', operate: 'IN', custom: { 1: 'green', 2: 'green', 3: 'green', 4: 'green', 5: 'green', 6: 'green', }, searchList: { 1: '仅镜架', 2: '现货处方镜', 3: '定制处方镜', 4: '镜架+现货', 5: '镜架+定制', 6: '现片+定制片', 0: '待处理' }, formatter: Table.api.formatter.status },
                        { field: 'order_type', title: __('订单类型'), custom: { 1: 'blue', 2: 'blue', 3: 'blue', 4: 'blue', 5: 'blue', 6: 'blue', 10: 'blue' }, searchList: { 1: '普通订单', 2: '批发单', 3: '网红单', 4: '补发单', 5: '补差价', 6: '一键代发',10:'货到付款' }, addClass: 'selectpicker', data: 'multiple', operate: 'IN', formatter: Table.api.formatter.status },
                            ...
                            field: 'operate', title: __('Operate'), table: table, events: Table.api.events.operate, buttons: [
                                {
                                    ...
                                    icon: 'fa fa-list',
                                    url: 'order/printlabel/zeelool_jp/detail',
                                ...
                                },
                                {
                                    ...
                                    classname: 'btn btn-xs  btn-primary  btn-dialog',
                                    icon: 'fa fa-list',
                                    url: 'order/printlabel/zeelool_jp/operational',
            ...
            $('.btn-batch-printed').click(function () {
                ...
                window.open(Config.moduleurl + '/order/printlabel/zeelool_jp/batch_print_label/id_params/' + id_params, '_blank');
            });
            ...
            $('.btn-batch-export-xls').click(function () {
                var ids = Table.api.selectedids(table);
                if (ids.length > 0) {
                    window.open(Config.moduleurl + '/order/printlabel/zeelool_jp/batch_export_xls?id_params=' + ids, '_blank');
                } else {
                    var options = table.bootstrapTable('getOptions');
                    var search = options.queryParams({});
                    var filter = search.filter;
                    var op = search.op;
                    window.open(Config.moduleurl + '/order/printlabel/zeelool_jp/batch_export_xls?filter=' + filter + '&op=' + op, '_blank');
                }
            ...
            $('.btn-tag-printed').click(function () {
                ...
                Layer.confirm(
                    ...
                    function (index) {
                        Layer.close(index);
                        Backend.api.ajax({
                            url: Config.moduleurl + '/order/printlabel/zeelool_jp/tag_printed',
                            data: { id_params: ids },
                            type: 'post'
                        }, function (data, ret) {
                            if (data == 'success') {
            ...
            $('.btn-set-status').click(function () {
                ...
                Layer.confirm(
                    ...
                    function (index) {
                        Layer.close(index);
                        Backend.api.ajax({
                            url: Config.moduleurl + '/order/printlabel/zeelool_jp/setOrderStatus',
        ...
        operational: function () {
            ...
            Table.api.init({
                ...
                pagination: false,
                extend: {
                    index_url: 'order/printlabel/zeelool_jp/operational' + location.search + '&ids=' + Config.ids,
                }
            });
        ...
        _list: function () {
            ...
            Table.api.init({
                ...
                showToggle: false,
                extend: {
                    index_url: 'order/printlabel/zeelool_jp/_list' + location.search,
                    table: 'sales_flat_order',
                }
            });
            ...
            $('.btn-batch-export-xls').click(function () {
                ...
                window.open(Config.moduleurl + '/order/printlabel/zeelool_jp/batch_export_xls/id_params/' + id_params, '_blank');
            });
