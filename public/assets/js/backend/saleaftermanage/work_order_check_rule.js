            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'work_create_person_id', title: __('创建人或创建组的id'),operate:false},

                        {field: 'work_create_person', title: __('创建人或创建组名称'),operate:false},

                        {field: 'step_id', title: __('措施'),searchList: $.getJSON('saleaftermanage/work_order_list/getMeasureContent')},
