                    ...
                    if (id) {
                        ...
                        Backend.api.ajax({
                            ...
                            for (var i in data) {
                                ...
                                shtml += ' <td><input id="c-sample_num" class="form-control" oninput="if(value < 0){alert(\'只能输入正整数！\');value = 0}" name="sample_num[]" value="' + data[i].sample_num + '" type="text"></td>'
                                shtml += ' <td><input id="c-in_stock_num" class="form-control" oninput="if(value < 0){alert(\'只能输入正整数！\');value = 0}" name="in_stock_num[]" value="' + data[i].quantity_num + '" type="text"></td>'
                                shtml += ' <td>'
