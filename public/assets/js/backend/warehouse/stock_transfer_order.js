    ...
    var Controller = {
        ...
        danger_list: function () {
            ...
            Table.api.init({
                ...
                pageList: [10, 25, 50, 100],
                extend: {
                    index_url: 'warehouse/stock_transfer_order/danger_list' + location.search,
                }
            });
                            ...
                            buttons: [
                                {
                                    ...
                                    classname: 'btn btn-xs btn-primary btn-dialog',
                                    icon: 'fa fa-list',
                                    url: 'warehouse/stock_transfer_order/danger_detail',
                                    extend: 'data-area = \'["100%","100%"]\' target=\'_blank\'',
                                    callback: function (data) {
                                        Layer.alert("接收到回传数据：" + JSON.stringify(data), {title: "回传数据"});
                                    },
